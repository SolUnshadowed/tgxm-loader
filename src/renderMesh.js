...
// reference: https://github.com/cohaereo/alkahest/blob/main/crates/alkahest-data/src/tfx.rs#L10
	...
	constructor(renderMesh, geometryHash, renderMeshIndex)
	{
		...
		for ( let vertexBufferIndex = 0; vertexBufferIndex < vertexBufferCount; vertexBufferIndex++)
		{
			...
			)
			{
				...
				/*
				I was wondering why I put this check here, so it happens to be a part of original Spasm library:
				https://github.com/lowlines/destiny-tgx-loader/blob/a40ac48ca27b5ad4c2e437616f8cc65137ad6b8a/bnet-src/spasm/spasm_render_mesh.js#L270
